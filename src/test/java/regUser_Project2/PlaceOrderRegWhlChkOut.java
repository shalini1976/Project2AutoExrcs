...
public class PlaceOrderRegWhlChkOut extends CallingAutoExercise {
	WebDriver driver;

	public PlaceOrderRegWhlChkOut(WebDriver ldriver)
	{
		driver=ldriver;
...
//Click Proceed to Checkout
	...
	public void deleteAccount()
	{
		...
		System.out.println("TEST CASE14 COMPLETED SUCCESSFULLY\n");
	}
