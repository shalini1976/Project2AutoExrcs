...
public class PlaceOrderRegBefChkOut extends CallingAutoExercise {
	WebDriver driver;

	public PlaceOrderRegBefChkOut(WebDriver ldriver)
	{
		driver=ldriver;
		PageFactory.initElements(driver, this);
	}
	@FindBy(xpath="//ul[@class='nav navbar-nav']/child::li[4]/child::a/child::i") WebElement signup;
