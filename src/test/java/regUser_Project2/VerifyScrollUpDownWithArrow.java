...
public class VerifyScrollUpDownWithArrow extends CallingAutoExercise {
	WebDriver driver;

	public VerifyScrollUpDownWithArrow(WebDriver ldriver)
	{
		driver=ldriver;
	...
	public void verifyFullText()
	{
		...
		System.out.println("TEST CASE25 COMPLETED SUCCESSFULLY\n");
	}
